...
public class mainFrame extends javax.swing.JFrame {
    ...
    public Image getIconImage() {
       Image retValue = Toolkit.getDefaultToolkit().
             getImage(ClassLoader.getSystemResource("UI.Views/L.png"));
    ...
    private void initComponents() {
        ...
        SaveText.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        SaveText.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        SaveText.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SaveTextActionPerformed(evt);
            }
        });
        jToolBar2.add(SaveText);
    ...
    private void OpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OpenActionPerformed
        ...
        try{
            ...
            if(file!=null)
                GeneradorLex.setText(mainFrameController.loadText(file));
    ...
    private void SaveTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveTextActionPerformed
        if(GeneradorLex.getText()!=null)
            try{
                ...
                File file =saveWindow.getSelectedFile();
                if(file!=null)
                    mainFrameController.saveText(file.getPath(), GeneradorLex.getText());
            }catch(Exception ex){
                System.out.println(ex.toString());
            }
        else
